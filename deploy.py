...
class Upload(Resource):
    def get(self,file1,file2):
            
            K.clear_session()
            FOLDER_PATH=r'C:\Users\ABHINEET SINGH\Desktop\postman api'
            FILE_NAME1=file1
            FILE_NAME2=file2
            ...
            # display faces on the original image
            draw_image_with_boxes1(FILE_PATH1, faces1)
            #cv2.imwrite('bounded.jpg',)
...
api.add_resource(Upload,'/upload/<path:file1>/<path:file2>')
